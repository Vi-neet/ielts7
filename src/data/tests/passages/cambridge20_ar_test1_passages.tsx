...
export const Cambridge20ARTest1Passages = () => {
  return (
    <div>
      {/* Reading Passage 1 */}
      ...
      <div className="passage">
        ...
        <div className="passage-title">
          <h3>Bringing elms back to Britain</h3>
          <p>
            <em>
        ...
        <div className="passage-content">
          <div className="section">
            ...
            <p>
              ...
              realise the impact [elms had] … They were significant, large trees
              … then they were gone.'
            </p>
          </div>
      ...
      <div className="passage">
        ...
        <div className="passage-title">
          <h3>How stress affects our judgement</h3>
        </div>
        ...
        <div className="passage-content">
          ...
          <p>
            The good news, however, is that positive emotions, such as hope, are
            contagious too, and are powerful in inducing people to act to find
            solutions. Being aware of the close relationship between people's
            emotional state and how they process information can help us frame
            our messages more effectively and become conscientious agents of
            change.
          </p>
        </div>
      </div>
