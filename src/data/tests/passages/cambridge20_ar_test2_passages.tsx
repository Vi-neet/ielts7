...
export const Cambridge20ARTest2Passages = () => {
  return (
    <div>
      {/* Reading Passage 1 */}
      <div className="passage">
        ...
        <div className="passage-content">
          ...
          <p>
            ...
            average around 500 kilograms. It moves between fresh water and salt
            water, taking advantage of coastal mangroves and coral reefs,
          ...
          <p>
            ...
            landlocked countries such as Mali and Niger.
          </p>

          <p>
            The Amazonian manatee is the smallest species, though it is still a
            big animal. It grows to about 2.5 metres long and 350 kilograms.
            Amazonian manatees favour calm, shallow waters that are above 23°C.
            This species is found in fresh water in the Amazon Basin in Brazil,
      ...
      <div className="passage">
        ...
        <div className="passage-title">
          ...
          <p>
            <em>
              A psychologist explains why we put off important tasks and how we
      ...
      <div className="passage">
        ...
        <div className="passage-title">
          <h3>Invasion of the Robot Umpires</h3>
        </div>
        ...
        <div className="passage-content">
          ...
          <p>
            ...
            game's animating force—countless arguments between a team's manager
            and the umpire have taken place over its boundaries and whether a
            ball had crossed through it. The rules of play have evolved in
            various stages. Today, everyone knows that you may scream your
            disagreement in an umpire's face, but you must never shout personal
            abuse at them or touch them. That's a no-no. When the robo-umpires
            came, however, the arguments stopped.
          </p>
          ...
          <p>
            ...
            that, compared to a human's, the robot's strike zone seems too
          ...
          <p>
            <em>
              *strike: a strike is when the batter swings at a ball and misses
              or when the batter does not swing at a ball that passes through
              the strike zone.
            </em>
          </p>
        </div>
