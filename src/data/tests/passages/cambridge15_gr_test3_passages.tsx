// Cambridge 15 General Reading Test 3 - Passages
import React from "react";

/**
 * Component that displays the reading passages for Cambridge 15 General Reading Test 3
 */
export const Cambridge15GRTest3Passages: React.FC = () => {
  return (
    <div className="reading-passage p-4 bg-white">
      
      {/* SECTION 1 */}
      <div className="mb-8">
        <h3 className="text-lg font-bold mb-4" id="SECTION_1">SECTION 1</h3>
        
        <div className="mb-4">
          <p className="mb-2"><strong>Questions 1-14</strong></p>
          <p className="mb-2">Read the text below and answer Questions 1-7.</p>
        </div>
        
        <h4 className="font-bold mb-2" id="Young_Fashion_Designer_UK_competition">Young Fashion Designer UK competition</h4>
        ...
        <p className="mb-4">1) Provide three A3 colour copies from your design folder.</p>
        
        <p className="mb-4">You must include:</p>
        <p className="mb-1">– initial ideas about the clothing</p>
        <p className="mb-4">– a close-up photograph of the front and back view of the finished clothing.</p>
        
        <p className="mb-1">2) Please label each sheet clearly with your name and school (on the back).</p>
        <p className="mb-1">3) Print off a copy of your registration form and attach it to your work.</p>
        <p className="mb-4">4) Post your entry to the Young Fashion Designer Centre.</p>
        ...
        <div className="mb-4 mt-6">
          <p className="mb-2">Read the text below and answer <strong>Questions 8-14</strong>.</p>
        </div>
        
        <h4 className="font-bold mb-2" id="Which_keyboard_should_you_buy">Which keyboard should you buy?</h4>
        ...
        <p className="mb-2"><strong>A Logitech K120</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>B Cherry MX 3.0 Keyboard</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>C Logitech K780</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>D Microsoft Sculpt Ergonomic</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>E Microsoft Universal Bluetooth Keyboard</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>F Corsair Strafe RGB Keyboard</strong></p>
        <p className="mb-4">
      ...
      {/* SECTION 2 */}
      <div className="mb-8">
        <h3 className="text-lg font-bold mb-4" id="SECTION_2">SECTION 2</h3>
        
        <div className="mb-4">
          <p className="mb-2"><strong>Questions 15-27</strong></p>
          <p className="mb-2">Read the text below and answer Questions 15-20.</p>
        </div>
        
        <h4 className="font-bold mb-2" id="Working_for_a_small_company_may_be_better_than_you_think">Working for a small company may be better than you think</h4>
        ...
        <div className="mb-4 mt-6">
          <p className="mb-2">Read the text below and answer <strong>Questions 21-27</strong>.</p>
        </div>
        
        <h4 className="font-bold mb-2" id="Starting_a_new_job">Starting a new job</h4>
        ...
        <p className="mb-2"><strong>B</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>C</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>D</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>E</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>F</strong></p>
        <p className="mb-4">
        ...
        <p className="mb-2"><strong>G</strong></p>
        <p className="mb-4">
      ...
      {/* SECTION 3 */}
      <div className="mb-8">
        <h3 className="text-lg font-bold mb-4" id="SECTION_3">SECTION 3</h3>
        
        <div className="mb-4">
          <p className="mb-2"><strong>Questions 28-40</strong></p>
          <p className="mb-2">Read the text below and answer Questions 28-40.</p>
        </div>
        
        <h4 className="font-bold mb-2" id="How_animals_keep_fit">How animals keep fit</h4>
...
export default Cambridge15GRTest3Passages;
