...
export const Cambridge20ARTest3Passages: React.FC = () => {
  return (
    <div className="passages-container">
      <div className="passage-section">
        ...
        <div className="passage-content">
          ...
          <p>
            Today, the US frozen food industry has a turnover of over $66
        ...
        <div className="passage-content">
          ...
          <div className="section">
            ...
            <p>
              ...
              which in turn get protection, while their photosynthesizing of the
          ...
          <div className="section">
            ...
            <p>
              ...
              not true. You go there and the first thing you think is: where …
              are the birds? Where are the animals? They are hiding in the
              trees, of course. No, if you want beauty and wildlife, you want a
              coral reef. Put on a mask and stick your head under the water. The
              sight is mind-blowing.'
            </p>
          </div>
      ...
      <div className="passage-section">
        ...
        <div className="passage-content">
          ...
          <p className="subtitle">
            <em>
              Three leaders in their fields answer questions about our
          ...
          <p>
            ...
            reliability and flexibility of humans. … Expecting a machine close
            to the creative intelligence of a human within the next 50 years
          ...
          <p>
            ...
            that … we tend to imagine they are greater and more powerful than
            they really are and subsequently they become so.'
          </p>
          ...
          <div className="footnotes">
            <h4>Footnotes:</h4>
            <p>
              <strong>terraforming:</strong> modifying a planet's atmosphere to
              suit human needs
            </p>
            <p>
              <strong>singularity:</strong> the point when robots will be able
              to start creating ever more sophisticated versions of themselves
            </p>
          </div>
        </div>
      </div>
...
export default Cambridge20ARTest3Passages;
