      ...
      <div className="lg:col-span-6 bg-forest-ink text-white p-10 lg:p-16 flex flex-col justify-between relative overflow-hidden min-h-[480px] lg:min-h-screen">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-lg space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold font-bricolage text-white leading-tight">
              Welcome back to your preparation portal.
            </h1>
            <p className="text-white/75 font-inter text-base leading-relaxed">
              Sign in to resume saved practice tests, review essay feedback, and track your band score progress.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-10 mt-10 border-t border-white/15 font-inter text-sm text-white/90 max-w-md">
            ...
            <div className="flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-highlighter-yellow shrink-0" />
              <span>Instant score calculation & answer keys</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle2 className="w-5 h-5 text-highlighter-yellow shrink-0" />
              <span>Writing Task 1 & Task 2 review feedback</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 pt-10 border-t border-white/15 font-inter text-sm text-white/80">
          <p className="italic mb-1.5">
            "Practicing under timed exam conditions helped me boost my score by a full band."
          </p>
          <span className="font-bold text-highlighter-yellow">— Candidate Band 7.5</span>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-6">
          <div>
            ...
            <p className="text-forest-ink/65 text-sm">
              Enter your credentials below to access your student portal.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold text-[#cb5521] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-forest-ink/60 font-inter pt-4">
            ...
            <Link href={`/signup?redirect=${encodeURIComponent(redirect)}`} className="font-bold text-forest-ink underline hover:text-terracotta">
